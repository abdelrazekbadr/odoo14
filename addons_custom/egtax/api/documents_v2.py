...
class Address:
    ...
    def from_dict(obj: Any) -> 'Address':
        ...
        branch_id = from_str(obj.get("branchID"))
        return Address(country=country, governate=governate, region_city=region_city, street=street,
                       building_number=building_number, postal_code=postal_code, floor=floor, room=room,
                       landmark=landmark,additional_information=additional_information, branch_id=branch_id)
